...
```
console.log will pritnt on the console ie console.log('hi') that will say hi in the termanal the retrun will send the values to the funtion again.
```

**_What's the difference between defining and calling a function?_**

```
defining is describing a vareble ie let x = 6 calling a fuction will set it argument and set parameter
```
...
```
anything under '' or " " "this is a string"
```

**_Number_**

```
valuse that dont have "" or ' ' that are numbers 1 2 3 
```

**_Boolean_**

```
ture or faulse awnsers like 1=1 ture or 33<4 faulse >
```

**_Array_**

```
[ "things that are in the bracks" , "like this for exaample", " XD "]
```
